		...
		return {
			...
			template:
				'<span ng-show="vm.canBeValidated() && vm.isValid()" ' +
					'class="fa fa-2x fa-check-square form-control-feedback form-validation-top-right"></span>' +
				'<span ng-show="vm.canBeValidated() && !vm.isValid()" ' +
					'class="fa fa-2x fa-exclamation-triangle form-control-feedback form-validation-top-right"></span>',
