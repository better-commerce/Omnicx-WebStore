...
function openChatBox() {
    $(".chatboxFrame").addClass("active");
    $(".chatboxIcon").removeClass("active");
    $(".chatboxIcon").addClass("hide");
    $(".chatboxIconClose").removeClass("hide");
    $(".chatboxIconClose").addClass("active");
}
function closeChatBox() {
    $(".chatboxFrame").removeClass("active");
    $(".chatboxIcon").addClass("active");
    $(".chatboxIcon").removeClass("hide");
    $(".chatboxIconClose").addClass("hide");
    $(".chatboxIconClose").removeClass("active");
}
