(function () {
    ...
    function checkoutCtrl($scope, checkoutConfig, globalConfig, $http, model, $timeout, CapturePlus) {
        ...
        function setShipping(shipMethod) {
            ...
            if (shipMethod != null) {
                if (shipMethod.displayName == 'Click and Collect') {
        ...
        function paymentMethod() {
            ...
            if (ck.model.checkout.selectedShipping.displayName == 'Click and Collect') {
            ...
            var checkout = {
                ...
                selectedShipping: ck.model.checkout.selectedShipping, storeAddress: ck.model.checkout.storeAddress, password: ck.model.checkout.password, giftOrMe: ck.model.checkout.giftOrMe, companyId: ck.model.checkout.companyId
            }
                    ...
                    if (data != null && data.length > 0) {
                        ...
                        if (!ck.model.checkout.basket.isQuote) {
                            ...
                            if (index >= 0) {
                                ...
                                ck.model.checkout.shippingAddress = data[0];
                            }
                        } else {
        ...
        function ValidateDeliveryMethod() {
            ...
            if (ck.model.checkout.selectedShipping.countryCode == ck.model.checkout.shippingAddress.countryCode) {
                ...
                //    if (obj.countryCode == ck.model.checkout.shippingAddress.countryCode) {
                //        ck.selectedDelivery = obj;
                //    }
                //});
                //ck.model.checkout.selectedShipping = ck.selectedDelivery;
