...
namespace ASP
{
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/Search/Layout1/_ProductWidgetNew.cshtml")]
    public partial class _Views_Search_Layout1__ProductWidgetNew_cshtml : Omnicx.WebStore.Core.Services.Infrastructure.CustomBaseViewPage<dynamic>
    {
        public _Views_Search_Layout1__ProductWidgetNew_cshtml()
        {
        }
        public override void Execute()
        {
            
            #line 1 "..\..\Views\Search\Layout1\_ProductWidgetNew.cshtml"
  
/*
    Name: Product List View Widget For Grid and List
    Purpose: Show Product All detail in List view
    Structure: /Views/Search/Layout1/_ProductWidgetNew.cshtml
    Contains (Partial Views Used):

    Contained In (Where we Use this View):
        a-/Views/Search/Layout1/_SearchResultCategory.cshtml
    */
...
WriteAttribute("href", Tuple.Create(" href=\"", 510), Tuple.Create("\"", 562)
, Tuple.Create(Tuple.Create("", 517), Tuple.Create<System.Object, System.Int32>(Href("~/Account/RemoveWishList/{{product.recordId}}")
, 517), false)
);
...
WriteLiteral("><strong>");
            ...
            #line 28 "..\..\Views\Search\Layout1\_ProductWidgetNew.cshtml"
...
WriteLiteral(">\r\n                        <strong>");
            ...
            #line 36 "..\..\Views\Search\Layout1\_ProductWidgetNew.cshtml"
...
WriteLiteral(" class=\"col-sm-4 col-xs-4 no-padding quantity-info\"");
...
WriteLiteral("></a>\r\n");
            ...
            #line 48 "..\..\Views\Search\Layout1\_ProductWidgetNew.cshtml"
...
WriteLiteral("></a>\r\n");
            ...
            #line 51 "..\..\Views\Search\Layout1\_ProductWidgetNew.cshtml"
                }
                else
                {
...
WriteLiteral("></a>\r\n");
            ...
            #line 55 "..\..\Views\Search\Layout1\_ProductWidgetNew.cshtml"
                }
...
WriteLiteral(" class=\"action-info\"");
...
WriteLiteral("><span>");
            ...
            #line 59 "..\..\Views\Search\Layout1\_ProductWidgetNew.cshtml"
                                                                                                                                     Write(LT("ProductDetail.Label.AddToBasket", "Add To Basket"));
...
WriteLiteral("</span></a>\r\n");
            ...
            #line 60 "..\..\Views\Search\Layout1\_ProductWidgetNew.cshtml"
...
WriteLiteral("><span>");
            ...
            #line 62 "..\..\Views\Search\Layout1\_ProductWidgetNew.cshtml"
                                                                                                                                        Write(LT("ProductDetail.Label.AddToBasket", "Add To Basket"));
...
WriteLiteral("</span></a>\r\n");
            ...
            #line 63 "..\..\Views\Search\Layout1\_ProductWidgetNew.cshtml"
                }
...
WriteLiteral(" class=\"techImagePanel\"");

WriteLiteral(">\r\n        <div");

WriteLiteral(" class=\"imagebig-info\"");
...
WriteLiteral(" ng-repeat=\"img in product.images track by $index\"");

WriteLiteral(" data-target=\"#product-quick-view-modal\"");

WriteLiteral(" ng-if=\"img.tag===\'Image2\'\"");

WriteLiteral(">\r\n                <img");

WriteLiteral(" ng-src=\"{{img.url==\'\'?DEFAULT_IMAGE_URL:img.url}}\"");
