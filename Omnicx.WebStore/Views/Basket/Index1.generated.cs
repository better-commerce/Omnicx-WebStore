...
WriteAttribute("ng-init", Tuple.Create(" ng-init=\'", 1387), Tuple.Create("\'", 1432)
, Tuple.Create(Tuple.Create("", 1397), Tuple.Create("gm.initBasket(", 1397), true)
            
            #line 35 "..\..\Views\Basket\Index.cshtml"
, Tuple.Create(Tuple.Create("", 1411), Tuple.Create<System.Object, System.Int32>(Html.JsonFor(Model)
...
WriteLiteral(" class=\"row transparentContainer\"");
...
WriteLiteral(">");
            ...
            #line 54 "..\..\Views\Basket\Index.cshtml"
                                         Write(LT("YourBag.Text.YourBag", "My Cart"));
...
WriteLiteral(" class=\"col-sm-3 col-xs-12 no-padding margin-top-sm\"");
...
WriteLiteral(">\r\n");
            ...
            #line 78 "..\..\Views\Basket\Index.cshtml"
...
WriteLiteral("></a>\r\n");
            ...
            #line 81 "..\..\Views\Basket\Index.cshtml"
                                    }
                                    else
                                    {
...
WriteAttribute("ng-show", Tuple.Create(" ng-show=\"", 8009), Tuple.Create("\"", 8092)
, Tuple.Create(Tuple.Create("", 8019), Tuple.Create("items.displayInBasket", 8019), true)
, Tuple.Create(Tuple.Create(" ", 8040), Tuple.Create("&&", 8041), true)
, Tuple.Create(Tuple.Create(" ", 8043), Tuple.Create("items.itemType", 8044), true)
, Tuple.Create(Tuple.Create(" ", 8058), Tuple.Create("==", 8059), true)
            
            #line 114 "..\..\Views\Basket\Index.cshtml"
                                       , Tuple.Create(Tuple.Create("", 8061), Tuple.Create<System.Object, System.Int32>(ItemTypes.Bundle.GetHashCode()
...
WriteAttribute("ng-if", Tuple.Create(" ng-if=\"", 8302), Tuple.Create("\"", 8403)
, Tuple.Create(Tuple.Create("", 8310), Tuple.Create("bundle.parentProductId", 8310), true)
, Tuple.Create(Tuple.Create(" ", 8332), Tuple.Create("==", 8333), true)
, Tuple.Create(Tuple.Create(" ", 8335), Tuple.Create("items.productId", 8336), true)
, Tuple.Create(Tuple.Create(" ", 8351), Tuple.Create("&&", 8352), true)
, Tuple.Create(Tuple.Create(" ", 8354), Tuple.Create("items.itemType", 8355), true)
, Tuple.Create(Tuple.Create(" ", 8369), Tuple.Create("==", 8370), true)
            
            #line 115 "..\..\Views\Basket\Index.cshtml"
                                                                                                                              , Tuple.Create(Tuple.Create("", 8372), Tuple.Create<System.Object, System.Int32>(ItemTypes.Bundle.GetHashCode()
...
WriteLiteral(">\r\n                                                <strong>");
            ...
            #line 120 "..\..\Views\Basket\Index.cshtml"
...
WriteLiteral(">");
            ...
            #line 145 "..\..\Views\Basket\Index.cshtml"
...
WriteAttribute("href", Tuple.Create(" href=\"", 11697), Tuple.Create("\"", 11721)
            
            #line 159 "..\..\Views\Basket\Index.cshtml"
, Tuple.Create(Tuple.Create("", 11704), Tuple.Create<System.Object, System.Int32>(ViewBag.PrevPage
...
WriteAttribute("href", Tuple.Create(" href=\"", 11871), Tuple.Create("\"", 11915)
            
            #line 160 "..\..\Views\Basket\Index.cshtml"
, Tuple.Create(Tuple.Create("", 11878), Tuple.Create<System.Object, System.Int32>(checkoutUrl
            
            #line default
            #line hidden
, 11878), false)
, Tuple.Create(Tuple.Create("", 11890), Tuple.Create("/{{gm.basketResponse.id}}", 11890), true)
);
...
WriteLiteral("></i> ");
            ...
            #line 165 "..\..\Views\Basket\Index.cshtml"
...
WriteLiteral(">");
            ...
            #line 167 "..\..\Views\Basket\Index.cshtml"
...
WriteLiteral(">");
            ...
            #line 195 "..\..\Views\Basket\Index.cshtml"
...
"tr>\r\n                                        <td>");
            ...
            #line 200 "..\..\Views\Basket\Index.cshtml"
...
WriteLiteral(">\r\n                                        <td>");
            ...
            #line 219 "..\..\Views\Basket\Index.cshtml"
...
WriteAttribute("ng-init", Tuple.Create(" ng-init=\"", 19019), Tuple.Create("\"", 19070)
, Tuple.Create(Tuple.Create("", 19029), Tuple.Create("pm.getBasketRelatedProducts(\'", 19029), true)
            
            #line 257 "..\..\Views\Basket\Index.cshtml"
                                         , Tuple.Create(Tuple.Create("", 19058), Tuple.Create<System.Object, System.Int32>(Model.Id
            
            #line default
            #line hidden
, 19058), false)
, Tuple.Create(Tuple.Create("", 19067), Tuple.Create("\');", 19067), true)
);
...
WriteLiteral("></i>\r\n        <h1>");
            ...
            #line 283 "..\..\Views\Basket\Index.cshtml"
...
WriteLiteral("\r\n    <script>\r\n        var basketToWishlist = \'");
            ...
            #line 289 "..\..\Views\Basket\Index.cshtml"
...
WriteLiteral("\';\r\n        var basketRelatedProducts = \'");
            ...
            #line 290 "..\..\Views\Basket\Index.cshtml"
...
WriteLiteral("\';\r\n        var searchProductUrl = \'");
            ...
            #line 291 "..\..\Views\Basket\Index.cshtml"
...
"                  });\r\n                        }\r\n                        if (ty" +
"peof (data.groups) !== undefined && data.groups !== null) {\r\n                   " +
"         rvp.productResponse.productGroupModel.groups = data.groups;\r\n          " +
"              }\r\n                        angular.forEach(rvp.productResponse.res" +
"ults, function (pro) {\r\n                            pro.bulkQty = 1;\r\n          " +
"              });\r\n                        rvp.productResponse.total = data.tota" +
"l;\r\n                        if (data.results.length == 0)\r\n                     " +
"       $scope.noRecord = true;\r\n                        else\r\n                  " +
"          $scope.noRecord = false;\r\n                        var filter = {};\r\n  " +
"                      angular.forEach(rvp.productResponse.filters, function (val" +
"ue, i) {\r\n                            if (pm.selectedKey == value.key) {\r\n      " +
"                          filter = value;\r\n                            }\r\n      " +
"                  });\r\n                        rvp.productResponse.filters = dat" +
