...
WriteLiteral(" ng-if=\"gm.basketResponse.grandTotal.raw.withTax > 0\"");
...
WriteLiteral(" ng-if=\"gm.basketResponse.subscriptionTotal.raw.withTax > 0 && gm.basketResponse." +
"hasSubscription\"");
...
WriteLiteral("                            ");
            ...
            #line 161 "..\..\Views\Basket\_HeaderBasketView.cshtml"
                       Write(LT("YourBag.Text.GrandTotal", "Subscription Total"));
...
WriteAttribute("href", Tuple.Create(" href=\"", 14173), Tuple.Create("\"", 14210)
            
            #line 168 "..\..\Views\Basket\_HeaderBasketView.cshtml"
, Tuple.Create(Tuple.Create("", 14180), Tuple.Create<System.Object, System.Int32>(Url.Action("Index", "Basket")
...
WriteAttribute("href", Tuple.Create(" href=\"", 14441), Tuple.Create("\"", 14486)
            
            #line 171 "..\..\Views\Basket\_HeaderBasketView.cshtml"
, Tuple.Create(Tuple.Create("", 14448), Tuple.Create<System.Object, System.Int32>(checkoutUrl
            
            #line default
            #line hidden
, 14448), false)
, Tuple.Create(Tuple.Create("", 14460), Tuple.Create("//{{gm.basketResponse.id}}", 14460), true)
);
